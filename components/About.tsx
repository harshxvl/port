  ...
  return (
    <Section id="about">
      <div className="grid gap-12 md:grid-cols-[minmax(0,16rem)_1fr] md:gap-16">
        ...
        <Stagger as="div" className="max-w-2xl space-y-6" stagger={0.1}>
          ...
          <StaggerItem as="dl" className="grid grid-cols-2 gap-x-8 gap-y-5 border-t border-border pt-6 sm:grid-cols-3">
            <div>
